...
async function seedDatabase() {
  try {
    ...
    const faqs = [
      ...
      {
        question: "Kan ik facturen scannen met Fiscavo?",
        answer: "Ja, de receipt-scanner gebruikt OCR-technologie om bedrag, datum en leverancier automatisch uit te lezen. Upload foto's van bonnetjes en facturen, Fiscavo categoriseert automatisch en koppelt aan de juiste uitgavencategorie.",
        category: "applicatie",
        businessType: "both",
        tags: ["facturen", "ocr", "scanner"],
      },
      {
        question: "Wat kost Fiscavo?",
        answer: "Fiscavo werkt met een simpel abonnement van €19/maand voor ZZP'ers en €49/maand voor BV's. Alle functies inbegrepen, geen verborgen kosten. 30 dagen gratis proberen zonder betalingsverplichting.",
        category: "pricing",
        businessType: "both",
